import CardBottomLogo from "../../assets/images/card-bottom-logo.svg";
...
function PlayerInfoWrapper({
  ...
  return (
    <div className="absolute bottom-0 w-full h-1/3">
      ...
      <img
        className="absolute bottom-0 pointer-events-none transform -translate-x-1/2 w-5/12 left-1/2"
        src={CardBottomLogo}
